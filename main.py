...
def download(bot, update):
    ...
    if "instagram.com" in instagram_post:
        ...
        try:
            ...
            bot.sendMessage(chat_id=update.message.chat_id, text="Send Me Only Public Instagram Posts ")
        ...
        if checking_video==True:
            ...
            bot.send_chat_action(chat_id=update.message.chat_id, action="typing")
            bot.sendMessage(chat_id=update.message.chat_id, text="I Can't Send You Private Posts :-( ")
    else:
